package com.school.apialumno.controller;

import com.school.apialumno.entity.Alumno;
import com.school.apialumno.service.AlumnoService;
...
public class AlumnoController {
    ...
    public ResponseEntity<?> update(@RequestBody Alumno alumnoDetails, @PathVariable Long id) {
        ...
        alumno.get().setPaterno(alumnoDetails.getPaterno());
        alumno.get().setMaterno(alumnoDetails.getMaterno());
        alumno.get().setNombres(alumnoDetails.getNombres());
        alumno.get().setPassword(alumnoDetails.getPassword());
        alumno.get().setSexo(alumnoDetails.getSexo());
        alumno.get().setDni(alumnoDetails.getDni());
        alumno.get().setNacimiento(alumnoDetails.getNacimiento());
        alumno.get().setCorreo(alumnoDetails.getCorreo());
        alumno.get().setTelefono(alumnoDetails.getTelefono());
        alumno.get().setImagen(alumnoDetails.getImagen());
        alumno.get().setEstado(alumnoDetails.getEstado());
    ...
    public List<Alumno> readAll() {
        List<Alumno> alumnos = StreamSupport
